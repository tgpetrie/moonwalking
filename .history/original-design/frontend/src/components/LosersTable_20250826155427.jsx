              ...
              >
                ...
                >
                  ...
                  <div className="flex items-center gap-4">
                    {/* Rank Badge (pink for losers) */}
                    <div className="table-rank table-rank-pink">{item.rank}</div>
                    {/* Symbol */}
                  ...
                  <div className="flex flex-row flex-wrap items-center gap-2 sm:gap-4 ml-0 sm:ml-4 w-full sm:w-auto">
                    ...
                    <span className="relative">
                      <span
                        onClick={e => { e.preventDefault(); handleToggleWatchlist(item.symbol, item.price); }}
