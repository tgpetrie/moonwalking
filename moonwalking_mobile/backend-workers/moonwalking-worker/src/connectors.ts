...
export class DiscordConnector implements Connector {
  name = 'discord';
  constructor(private token: string, private channelIds: string[]) {}
...
export class RedditConnector implements Connector {
  name = 'reddit';
  constructor(private clientId: string, private secret: string, private subs: string[]) {}
  async pullSince(sinceTs: number): Promise<RawPost[]> {
...
export class TelegramConnector implements Connector {
  name = 'telegram';
  constructor(private botToken: string, private chatIds: string[]) {}
  async pullSince(sinceTs: number): Promise<RawPost[]> {
