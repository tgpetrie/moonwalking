...
const lessons = [
  {
    id: 'intro-momentum',
    title: 'Reading Momentum Tables',
    file: require('../lessons/intro-momentum.md'),
  },
  ...
  return (
    <ScrollView style={styles.container} contentContainerStyle={{ padding: 16 }}>
      ...
      {lessons.map((l) => (
        <Pressable
          key={l.id}
          style={({ pressed }) => [styles.card, pressed && styles.cardP]}
          onPress={() => navigation.navigate('Lesson', { title: l.title, file: l.file })}
        >
