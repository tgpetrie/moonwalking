...
export default function GainersTable1Min({ toggleWatch, watchlist, data }) {
  const dummyData = [
    { asset: 'BTC-USD', change_1m: 2.13, price: 30000.45 },
    { asset: 'ETH-USD', change_1m: 1.87, price: 2100.87 },
  ];
    ...
    <div className="container mx-auto">
      {data.map((coin, idx) => (
        <div key={coin.asset} className="flex justify-between items-center border-b border-white/10 py-2">
          ...
          <div className="text-blue-400 text-sm font-mono">{coin.change_1m.toFixed(2)}%</div>
