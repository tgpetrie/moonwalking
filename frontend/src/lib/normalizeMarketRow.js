 ...
 *    symbol: "DOT-USD",
 *    current_price: 2.888,
 *    initial_price_1min: 2.853,
 *    price_change_percentage_1min: 1.2267,
 *    rank: 1,
 *    ...
 *  }
 */
export function normalize1m(row = {}) {
  return {
    ...
    prevPrice:
      typeof row.initial_price_1min === "number"
 ...
 *    symbol: "DOT-USD",
 *    current_price: 2.888,
 *    initial_price_3min: 2.8789,
 *    price_change_percentage_3min: 0.3157,
 *    rank: 1
 *  }
 */
export function normalize3m(row = {}, { side = "gain" } = {}) {
  return {
    ...
    price: typeof row.current_price === "number" ? row.current_price : null,
    prevPrice:
      typeof row.initial_price_3min === "number"
