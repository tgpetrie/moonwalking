...
# Relative URLs so Vite proxy can intercept in dev
VITE_API_BASE_URL=/api
VITE_WS_URL=/ws
# Absolute fallbacks for any code that expects full origins
VITE_API_URL=http://127.0.0.1:${BACKEND_PORT}/api
VITE_WS_ABSOLUTE=ws://127.0.0.1:${BACKEND_PORT}/ws
EOF_ENV
